...
Planning owner: [#9](https://github.com/cannontrodder/grenadier-pool-1998/issues/9). Status: agreed planning scope; implementation issues prepared for work. Implementation has not started.
