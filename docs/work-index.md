...
| [Phase 3 — First playable table](https://github.com/cannontrodder/grenadier-pool-1998/milestone/3) | [#9 — Define the first aim, shoot, and pot phase](https://github.com/cannontrodder/grenadier-pool-1998/issues/9) |
