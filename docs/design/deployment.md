...
This preview publishes the contents of `docs/design/` as a buildless static site. It contains design artifacts and clearly labeled placeholders, not gameplay. Game-engine, production-game hosting, storage, and networking choices remain open.
